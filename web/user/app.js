...
// limit" (np. Uptime serwera). Celowo bez wlasnego paska/dodatkowej linii
// - nizszy niz CPU/RAM/Dysk/Strony/Bazy (te maja meter-track) wyrownuje
// sie CSS-em (.tile-row-6 { align-items:stretch }), nie sztucznie
// dolozona trescia (proba z adresem IP jako 3. linia zostala odrzucona
// 2026-08-16 - user chcial rowna wysokosc, nie kolejna informacje).
