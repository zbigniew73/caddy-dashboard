...
${SVC_USER} ALL=(root) NOPASSWD: CDDASH_SYSTEMCTL, CDDASH_DNF, CDDASH_FIREWALL, CDDASH_SSH_PORT, CDDASH_REBOOT, CDDASH_FAIL2BAN, CDDASH_CADDY_PERF, CDDASH_MARIADB_INSTALL, CDDASH_MARIADB_PERF, CDDASH_MARIADB_TESTDB, CDDASH_POSTGRESQL_INSTALL, CDDASH_POSTGRESQL_PERF, CDDASH_POSTGRESQL_TESTDB, CDDASH_MONGODB_INSTALL, CDDASH_MONGODB_PERF, CDDASH_MONGODB_TESTDB, CDDASH_REDIS_INSTALL, CDDASH_REDIS_PERF, CDDASH_PHP_REPOS, CDDASH_PHP_LIST, CDDASH_PHP_INSTALL, CDDASH_PHP_SETTINGS, CDDASH_PHP_OPCACHE, CDDASH_PHP_MODULE, CDDASH_PHP_MODULE_LIST, CDDASH_FRANKENPHP_REPO, CDDASH_FRANKENPHP_LIST, CDDASH_FRANKENPHP_INSTALL, CDDASH_PHPMYADMIN_INSTALL, CDDASH_PHPMYADMIN_UNINSTALL, CDDASH_ADMINER_INSTALL, CDDASH_ADMINER_UNINSTALL, CDDASH_HOSTING_SLICE, CDDASH_QUOTA_EXT4, CDDASH_QUOTA_XFS, CDDASH_QUOTA_VERIFY, CDDASH_ACCOUNT_CREATE, CDDASH_ACCOUNT_DELETE, CDDASH_ACCOUNT_SLICE_SET, CDDASH_ACCOUNT_SLICE_REMOVE, CDDASH_ACCOUNT_SITES_COUNT, CDDASH_ACCOUNT_DISK_USAGE, CDDASH_HOSTING_USER_PWSTATUS, CDDASH_HOSTING_USER_SETPW, CDDASH_HOSTING_USER_CRONTAB_GET, CDDASH_HOSTING_USER_CRONTAB_SET, CDDASH_HOSTING_USER_CPU_TICKS, CDDASH_HOSTING_DB_MARIADB, CDDASH_HOSTING_DB_POSTGRESQL, CDDASH_HOSTING_DB_MONGODB, CDDASH_HOSTING_REDIS_APPLY, CDDASH_HOSTING_REDIS_STOP, CDDASH_HOSTING_REDIS_INFO, CDDASH_CRON_JOBS_COUNT, CDDASH_PAM_CHECK
EOF
