...
Cmnd_Alias CDDASH_RESTIC_INSTALL = ${INSTALL_DIR}/server/scripts/restic-install.sh local, ${INSTALL_DIR}/server/scripts/restic-install.sh official
Cmnd_Alias CDDASH_GO_INSTALL = ${INSTALL_DIR}/server/scripts/go-install.sh local, ${INSTALL_DIR}/server/scripts/go-install.sh official

${SVC_USER} ALL=(root) NOPASSWD: CDDASH_SYSTEMCTL, CDDASH_DNF, CDDASH_FIREWALL, CDDASH_SSH_PORT, CDDASH_REBOOT, CDDASH_FAIL2BAN, CDDASH_CADDY_PERF, CDDASH_MARIADB_INSTALL, CDDASH_MARIADB_PERF, CDDASH_POSTGRESQL_INSTALL, CDDASH_POSTGRESQL_PERF, CDDASH_MONGODB_INSTALL, CDDASH_MONGODB_PERF, CDDASH_REDIS_INSTALL, CDDASH_REDIS_PERF, CDDASH_RESTIC_INSTALL, CDDASH_GO_INSTALL
EOF
