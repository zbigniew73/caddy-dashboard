...
Cmnd_Alias CDDASH_HOSTING_SITE = ${INSTALL_DIR}/server/scripts/hosting-user-site.sh apply * *, ${INSTALL_DIR}/server/scripts/hosting-user-site.sh enable * *, ${INSTALL_DIR}/server/scripts/hosting-user-site.sh disable * *, ${INSTALL_DIR}/server/scripts/hosting-user-site.sh delete * *
