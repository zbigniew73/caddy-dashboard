...
Cmnd_Alias CDDASH_CADDY_PERF = ${INSTALL_DIR}/server/scripts/caddy-set-performance.sh, ${INSTALL_DIR}/server/scripts/caddy-set-performance.sh get, ${INSTALL_DIR}/server/scripts/caddy-set-performance.sh get-sites
Cmnd_Alias CDDASH_CADDY_LOGS = ${INSTALL_DIR}/server/scripts/caddy-ensure-logs.sh
Cmnd_Alias CDDASH_MAIL_INSTALL = ${INSTALL_DIR}/server/scripts/mail-install.sh, ${INSTALL_DIR}/server/scripts/mail-install.sh *
Cmnd_Alias CDDASH_MAIL_ACCESS = ${INSTALL_DIR}/server/scripts/mail-toggle-access.sh srv_* enable, ${INSTALL_DIR}/server/scripts/mail-toggle-access.sh srv_* disable
Cmnd_Alias CDDASH_MAIL_TLS_SWAP = ${INSTALL_DIR}/server/scripts/mail-tls-swap.sh enable *, ${INSTALL_DIR}/server/scripts/mail-tls-swap.sh disable *
Cmnd_Alias CDDASH_MAIL_SNI_SYNC = ${INSTALL_DIR}/server/scripts/mail-sni-sync.sh sync *, ${INSTALL_DIR}/server/scripts/mail-sni-sync.sh remove *, ${INSTALL_DIR}/server/scripts/mail-sni-sync.sh list
Cmnd_Alias CDDASH_POSTFIX_LIMITS = ${INSTALL_DIR}/server/scripts/postfix-set-limits.sh [0-9]* [0-9]*
Cmnd_Alias CDDASH_DOVECOT_LIMITS = ${INSTALL_DIR}/server/scripts/dovecot-set-limits.sh [0-9]*
Cmnd_Alias CDDASH_POSTFIX_MYDESTINATION = ${INSTALL_DIR}/server/scripts/postfix-add-mydestination.sh *
Cmnd_Alias CDDASH_DKIM_INSTALL = ${INSTALL_DIR}/server/scripts/dkim-install.sh install *, ${INSTALL_DIR}/server/scripts/dkim-install.sh status *
Cmnd_Alias CDDASH_MAIL_VIRTUAL_DOMAIN = ${INSTALL_DIR}/server/scripts/mail-virtual-domain.sh add *, ${INSTALL_DIR}/server/scripts/mail-virtual-domain.sh remove *, ${INSTALL_DIR}/server/scripts/mail-virtual-domain.sh list
Cmnd_Alias CDDASH_MAIL_VIRTUAL_ACCOUNT = ${INSTALL_DIR}/server/scripts/mail-virtual-account.sh add *, ${INSTALL_DIR}/server/scripts/mail-virtual-account.sh passwd *, ${INSTALL_DIR}/server/scripts/mail-virtual-account.sh remove *, ${INSTALL_DIR}/server/scripts/mail-virtual-account.sh list *
Cmnd_Alias CDDASH_MAIL_VIRTUAL_ALIAS = ${INSTALL_DIR}/server/scripts/mail-virtual-alias.sh add *, ${INSTALL_DIR}/server/scripts/mail-virtual-alias.sh remove *, ${INSTALL_DIR}/server/scripts/mail-virtual-alias.sh list *
Cmnd_Alias CDDASH_POSTFWD_INSTALL = ${INSTALL_DIR}/server/scripts/postfwd-install.sh
Cmnd_Alias CDDASH_POSTFWD_LIMITS = ${INSTALL_DIR}/server/scripts/postfwd-set-limits.sh [0-9]* [0-9]* [0-9]*
Cmnd_Alias CDDASH_POSTFIX_ANTISPAM = ${INSTALL_DIR}/server/scripts/postfix-antispam.sh enable, ${INSTALL_DIR}/server/scripts/postfix-antispam.sh disable
Cmnd_Alias CDDASH_SPAMASSASSIN_INSTALL = ${INSTALL_DIR}/server/scripts/spamassassin-install.sh
Cmnd_Alias CDDASH_SPAMASSASSIN_THRESHOLD = ${INSTALL_DIR}/server/scripts/spamassassin-set-threshold.sh [0-9]*
...
Cmnd_Alias CDDASH_ROUNDCUBE_INSTALL = ${INSTALL_DIR}/server/runtime-manager/scripts/roundcube-install.sh mysql, ${INSTALL_DIR}/server/runtime-manager/scripts/roundcube-install.sh sqlite
Cmnd_Alias CDDASH_ROUNDCUBE_UNINSTALL = ${INSTALL_DIR}/server/runtime-manager/scripts/roundcube-uninstall.sh
Cmnd_Alias CDDASH_ROUNDCUBE_CADDY_CONFIG = ${INSTALL_DIR}/server/scripts/roundcube-caddy-config.sh get, ${INSTALL_DIR}/server/scripts/roundcube-caddy-config.sh apply, ${INSTALL_DIR}/server/scripts/roundcube-caddy-config.sh remove
...
Cmnd_Alias CDDASH_HOSTING_USER_MAILBOX_STATS = ${INSTALL_DIR}/server/scripts/hosting-user-mailbox-stats.sh *
...
Cmnd_Alias CDDASH_HOSTING_PYTHON_APP = ${INSTALL_DIR}/server/scripts/hosting-user-python-app.sh create * * * *, ${INSTALL_DIR}/server/scripts/hosting-user-python-app.sh start * * * *, ${INSTALL_DIR}/server/scripts/hosting-user-python-app.sh stop * *, ${INSTALL_DIR}/server/scripts/hosting-user-python-app.sh status * *, ${INSTALL_DIR}/server/scripts/hosting-user-python-app.sh delete * *
Cmnd_Alias CDDASH_HOSTING_NODE_APP = ${INSTALL_DIR}/server/scripts/hosting-user-node-app.sh create * * * *, ${INSTALL_DIR}/server/scripts/hosting-user-node-app.sh start * * * * *, ${INSTALL_DIR}/server/scripts/hosting-user-node-app.sh stop * *, ${INSTALL_DIR}/server/scripts/hosting-user-node-app.sh status * *, ${INSTALL_DIR}/server/scripts/hosting-user-node-app.sh delete * *

${SVC_USER} ALL=(root) NOPASSWD: CDDASH_SYSTEMCTL, CDDASH_DNF, CDDASH_FIREWALL, CDDASH_SSH_PORT, CDDASH_REBOOT, CDDASH_FAIL2BAN, CDDASH_CADDY_PERF, CDDASH_CADDY_LOGS, CDDASH_MAIL_INSTALL, CDDASH_MAIL_ACCESS, CDDASH_MAIL_TLS_SWAP, CDDASH_MAIL_SNI_SYNC, CDDASH_POSTFIX_LIMITS, CDDASH_DOVECOT_LIMITS, CDDASH_POSTFIX_MYDESTINATION, CDDASH_DKIM_INSTALL, CDDASH_MAIL_VIRTUAL_DOMAIN, CDDASH_MAIL_VIRTUAL_ACCOUNT, CDDASH_MAIL_VIRTUAL_ALIAS, CDDASH_POSTFWD_INSTALL, CDDASH_POSTFWD_LIMITS, CDDASH_POSTFIX_ANTISPAM, CDDASH_SPAMASSASSIN_INSTALL, CDDASH_SPAMASSASSIN_THRESHOLD, CDDASH_MARIADB_INSTALL, CDDASH_MARIADB_PERF, CDDASH_MARIADB_TESTDB, CDDASH_POSTGRESQL_INSTALL, CDDASH_POSTGRESQL_PERF, CDDASH_POSTGRESQL_TESTDB, CDDASH_MONGODB_INSTALL, CDDASH_MONGODB_PERF, CDDASH_MONGODB_TESTDB, CDDASH_REDIS_INSTALL, CDDASH_REDIS_PERF, CDDASH_PHP_REPOS, CDDASH_PHP_LIST, CDDASH_PHP_INSTALL, CDDASH_PHP_SETTINGS, CDDASH_PHP_OPCACHE, CDDASH_PHP_MODULE, CDDASH_PHP_MODULE_LIST, CDDASH_PHPMYADMIN_INSTALL, CDDASH_PHPMYADMIN_UNINSTALL, CDDASH_ADMINER_INSTALL, CDDASH_ADMINER_UNINSTALL, CDDASH_ROUNDCUBE_INSTALL, CDDASH_ROUNDCUBE_UNINSTALL, CDDASH_ROUNDCUBE_CADDY_CONFIG, CDDASH_HOSTING_SLICE, CDDASH_QUOTA_EXT4, CDDASH_QUOTA_XFS, CDDASH_QUOTA_VERIFY, CDDASH_ACCOUNT_CREATE, CDDASH_ACCOUNT_DELETE, CDDASH_ACCOUNT_SLICE_SET, CDDASH_ACCOUNT_SLICE_REMOVE, CDDASH_ACCOUNT_SITES_COUNT, CDDASH_ACCOUNT_DISK_USAGE, CDDASH_HOSTING_USER_MAILBOX_STATS, CDDASH_HOSTING_USER_PWSTATUS, CDDASH_HOSTING_USER_SETPW, CDDASH_HOSTING_USER_CRONTAB_GET, CDDASH_HOSTING_USER_CRONTAB_SET, CDDASH_HOSTING_USER_CPU_TICKS, CDDASH_HOSTING_SITE, CDDASH_HOSTING_DB_MARIADB, CDDASH_HOSTING_DB_POSTGRESQL, CDDASH_HOSTING_DB_MONGODB, CDDASH_HOSTING_REDIS_APPLY, CDDASH_HOSTING_REDIS_STOP, CDDASH_HOSTING_REDIS_INFO, CDDASH_HOSTING_USER_SSHKEYS_GET, CDDASH_HOSTING_USER_SSHKEYS_SET, CDDASH_CRON_JOBS_COUNT, CDDASH_PAM_CHECK, CDDASH_HOSTING_BACKUP_REPO_INIT, CDDASH_HOSTING_BACKUP_JOB_WRITE, CDDASH_HOSTING_BACKUP_JOB_DELETE, CDDASH_HOSTING_BACKUP_RUN, CDDASH_HOSTING_BACKUP_SNAPSHOTS, CDDASH_HOSTING_BACKUP_RESTORE, CDDASH_HOSTING_PHP_POOL, CDDASH_HOSTING_PYTHON_APP, CDDASH_HOSTING_NODE_APP
EOF
